...
def parse_args():
    parser = argparse.ArgumentParser(description="Convert segmentation masks to colorized images")
    parser.add_argument("--src_path", type=str, help="Source directory containing mask files")
    parser.add_argument(
        "-s",
        "--suffix",
        type=str,
...
if __name__ == "__main__":
    args = parse_args()
    batch_convert_masks(src_path=args.src_path, suffix=args.suffix, dst_path=args.dst_path)
